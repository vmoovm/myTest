...
PinchZoom.prototype = {
    ...
    handleDragStart: function (event) {
        this.trigger(this.options.dragStartEventName);
        this.stopAnimation();
    ...
    handleDragEnd: function () {
        this.trigger(this.options.dragEndEventName);
        this.end();
    },
	trigger: function (callfn) {
		if (callfn) {
			callfn()
		}
	},
    ...
    handleZoomStart: function (event) {
        this.trigger(this.options.zoomStartEventName);
        this.stopAnimation();
        this.lastScale = 1;
        this.nthZoom = 0;
    ...
    handleZoomEnd: function () {
        this.trigger(this.options.zoomEndEventName);
        this.end();
    },
	
	handleTap: function () {
        this.trigger(this.options.tapEventName);
        this.end();
    },
    ...
    handleDoubleTap: function (event) {
        ...
        this.trigger(this.options.doubleTapEventName);
    },
