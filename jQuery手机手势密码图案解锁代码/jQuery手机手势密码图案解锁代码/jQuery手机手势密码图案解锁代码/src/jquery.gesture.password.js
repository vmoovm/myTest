...
(function ($) {
    ...
    var GesturePasswd= function (element, options) {
        ...
        this.$element.css({
            "position":"relation",
            "width":this.options.width * window.devicePixelRatio,
            "height":this.options.height* window.devicePixelRatio,
        ...
        this.initDraw=function(){
            if (window.devicePixelRatio) {
				this.$c.style.width = this.options.width* window.devicePixelRatio + "px";
				this.$c.style.height = this.options.height * window.devicePixelRatio + "px";
				this.$c.height = this.options.height * window.devicePixelRatio;
				this.$c.width = this.options.width * window.devicePixelRatio;
            ...
            this.$ctx.stroke();
            this.initImg=this.$ctx.getImageData(0,0,this.options.height * window.devicePixelRatio,this.options.height * window.devicePixelRatio);
        };
        this.initDraw();
        //this.$ctx.stroke();
        ...
        $(this.id).on ("mousedown touchstart",{that:that},startHandler);
        $(this.id).on ("mouseup touchend",{that:that},function(e){
            ...
            $(this.id).unbind("mousedown touchstart",startHandler);
            $(this.id).on ("mousedown touchstart",{that:that},startHandler);
        });
