...
(function() {
	...
	IosSelect.prototype = {
		...
		initLayer: function() {
			...
			this.iosSelectLayer.el.querySelector('.layer').style.height = this.options.headerHeight-(-this.options.itemHeight * this.options.itemShowCount) + this.options.cssUnit;
